...
<div class="form-group">
    {!! Form::label('Third Subtype (Optional)') !!} {!! add_help('This will lock the slot into a particular third subtype. Leave it blank if you would like to give the user more choices, or not select a subtype. The subtype must match the species selected above, and if no species is specified, the subtype will not be applied.') !!}
    {!! Form::select('subtype_id_3', $subtypes, $tag->getData()['subtype_id_3'], ['class' => 'form-control', 'id' => 'subtype_id_3']) !!}
</div>
